	...
	<div class="wid960 marAuto">
        <div class="form_cont marAuto">
            <form method="post" action="../function/mesPub.php" enctype="multipart/form-data">
                <input type="hidden" name="lost" value="lost_submit">
                <div class="form_name">
                    <span>物品名称</span><input type="text" value="" name="lost_name"/><dfn></dfn>
                </div>
                <div class="form_file">
                ...
                <div class="form_lost_place">
                    <span>地点</span><input type="text" name="lost_place"/><dfn></dfn>
                </div>
                <div class="form_lost_data">
                    <span>日期</span><input type="text" name="lost_data"/><dfn></dfn>
                </div>
                <div class="form_desc">
                    <span>物品描述</span><textarea cols="43" rows="5" style="resize:none;" name="lost_desc"></textarea><dfn></dfn>
                </div>
